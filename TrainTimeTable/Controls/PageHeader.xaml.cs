...
namespace TrainTimeTable.Controls
{
    public sealed partial class PageHeader : UserControl
    {
        public PageHeader()
        {
            ...
            this.Loaded += (s, a) =>
            {
                ShellView.Current.TogglePaneButtonRectChanged += Current_TogglePaneButtonSizeChanged;
                this.titleBar.Margin = new Thickness(ShellView.Current.TogglePaneButtonRect.Right, 0, 0, 0);
            };
        }
